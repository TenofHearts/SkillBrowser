...
class GatewayBenchCompareConfig(BaseModel):
    dataset: Optional[str] = None
    limit: int = 50
    top_k: int = 5
    selectors: list[str] = ["hybrid", "llm-baseline"]
    llm: str = "mock"
    workers: int = 10
...
class AppConfig(BaseModel):
    ...
    gatewaybench_compare: GatewayBenchCompareConfig = GatewayBenchCompareConfig()
